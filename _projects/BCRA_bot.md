...
A few months later, the idea of making a bot came to my mind and I immediately get to work on this project. I wanted a simple, automated way to publish monetary statistics—which are a fairly common topic of discussion in Argentina—on a daily basis, to make this information more accessible and engaging. That is how <a href='https://x.com/BCRA_bot'>@BCRA_bot</a> was concieved.
